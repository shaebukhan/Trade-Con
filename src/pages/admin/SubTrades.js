...
const SubTrades = () => {
    ...
    const handleAddSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post(`${process.env.REACT_APP_API}/api/v1/sub-trade/add-sub-trade`, formData, {
                headers: {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.put(`${process.env.REACT_APP_API}/api/v1/sub-trade/edit/${selectedTrade._id}`, formData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
    ...
    const handleDeleteSubTrade = async (subtrade) => {
        ...
        try {
            const { data } = await axios.delete(`${process.env.REACT_APP_API}/api/v1/sub-trade/delete/${subtrade._id}`);
            if (data.success) {
